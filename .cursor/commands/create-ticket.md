...
You are tasked with creating new tickets in the `.cursor/tickets/` directory. These tickets represent specific, isolated features, bugs, or tasks that need to be implemented.
...
1. **Check existing tickets**:
   ...
   - List all existing ticket files in `.cursor/tickets/`
...
1. **Present the ticket**:
   ...
   `.cursor/tickets/[number]-[title].md`
