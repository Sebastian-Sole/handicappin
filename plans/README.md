...
| 010 | Shot-level stats v1 (putts/FIR/penalties → GIR/FIR%/putts-per-round) ([#140](https://github.com/Sebastian-Sole/handicappin/issues/140)) | P2 | L | 008 ✓, 009 ✓ | IN PROGRESS (executor dispatched 2026-07-13; drift note: work around 009's analytics captures, add detailed_scoring_toggled event) |
