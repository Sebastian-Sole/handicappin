...
| 009 | Product analytics foundation (taxonomy + PostHog, web+native) ([#139](https://github.com/Sebastian-Sole/handicappin/issues/139)) | P1 | M | — (dispatch after PR #155 merged ✓) | DONE (approved after Revision 1; PR [#160](https://github.com/Sebastian-Sole/handicappin/pull/160) open — owner veto pending on live PostHog event renames) |
