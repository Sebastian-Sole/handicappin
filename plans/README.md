...
| 009 | Product analytics foundation (taxonomy + PostHog, web+native) ([#139](https://github.com/Sebastian-Sole/handicappin/issues/139)) | P1 | M | — (dispatch after PR #155 merged ✓) | DONE (merged to main 2026-07-13 via PR [#160](https://github.com/Sebastian-Sole/handicappin/pull/160), incl. event renames + captureException seam fix; owner setup pending: EU PostHog project + Vercel/EAS keys) |
| 010 | Shot-level stats v1 (putts/FIR/penalties → GIR/FIR%/putts-per-round) ([#140](https://github.com/Sebastian-Sole/handicappin/issues/140)) | P2 | L | 008 ✓, 009 ✓ | DONE (approved; PR [#161](https://github.com/Sebastian-Sole/handicappin/pull/161) open — ⚠️ prod migration applies manually via session pooler before deploy) |
