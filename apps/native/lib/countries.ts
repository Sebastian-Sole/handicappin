/**
 * Country list — verbatim mirror of the array in apps/web/components/
 * scorecard/country-combobox.tsx (value = stored string, label = display).
 * Regenerate by re-copying if web adds entries.
 */
