/**
 * MIRROR of apps/web/lib/statistics/player-type.ts over the native trust-boundary
 * scorecard type — keep in lockstep with web (pure functions; covered by
 * native unit tests).
 */
import type { ScorecardWithRound } from "@/lib/api/schemas/scorecard";
import type { PlayerTypeResult, PlayerTypeId } from "@/lib/statistics/types";
