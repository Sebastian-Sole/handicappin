 ...
 * handicap-derived statistics. Gating the whole screen on `summary.roundCount`
 ...
 * native branch identically. Web twin:
 * apps/web/lib/statistics/course-detail-display.ts.
 */
