...
} satisfies Meta<typeof ScoreBarChart>;
...
const sparse = [
  { key: "1", roundDate: "05-04-2025", roundTime: "10:00", score: 16.2, influencesHcp: true },
  { key: "2", roundDate: "19-04-2025", roundTime: "10:00", score: 14.8, influencesHcp: true },
  { key: "3", roundDate: "03-05-2025", roundTime: "10:00", score: 15.5, influencesHcp: true },
];

export const Default: Story = {
  args: { scores: populated },
};
...
export const AllInfluential: Story = {
  args: {
    scores: populated.map((s) => ({ ...s, influencesHcp: true })),
  },
};
