          ...
          <Badge
            className={`text-xs transition-colors duration-300 ${
              change === "improvement"
                ...
                : change === "achievement"
                ? "bg-yellow-100 dark:bg-yellow-900/50 text-yellow-800 dark:text-yellow-200 border-yellow-200 dark:border-green-700 hover:bg-yellow-100 dark:hover:bg-yellow-900/50 hover:text-yellow-800 dark:hover:text-yellow-200"
                : change === "increase"
