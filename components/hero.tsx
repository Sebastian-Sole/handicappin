...
const Hero = ({ profile, previousScores }: HeroProps) => {
  return (
    <section className="w-full py-4 md:py-8 lg:py-12 xl:py-24 bg-[url('/placeholder.svg?height=1080&width=1920')] bg-cover bg-center">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[1fr_460px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className="flex flex-col justify-between space-y-4 bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg h-full">
