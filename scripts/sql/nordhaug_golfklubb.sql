...
-- Type: 9-hole course (played as 18: front nine repeated as the back nine)
-- Generated by parse_scorecard.py; back nine (holes 10-18) added to satisfy the
-- 18-hole tee contract. Each back-nine hole repeats its front-nine par/distance
-- with stroke index +1 so all 18 stroke indexes stay unique (WHS 9-hole loop).
